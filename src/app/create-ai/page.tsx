        ...
        <div className="space-y-6">
          <div>
            ...
            <textarea
              ...
              className="w-full p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none !text-black"
              rows={3}
              disabled={isLoading}
            />
          ...
          <button
            ...
            className={`w-full py-4 px-6 rounded-lg font-semibold text-lg transition-all duration-200 ${!prompt.trim() || isLoading
